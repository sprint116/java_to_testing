...
public class ContactCreationTests {
  ...
  public void testUntitledTestCase() throws Exception {
    ...
    wd.findElement(By.name("nickname")).sendKeys("testing");
    wd.findElement(By.name("address")).clear();
    wd.findElement(By.name("address")).sendKeys("Testing");
    ...
    wd.findElement(By.name("address2")).sendKeys("TestingAddress");
