...
public class RestTests {
  ...
  private Set<Issue> getIssues() throws IOException {
    String response = getExecutor().execute(Request.Get("https://bugify.stqa.ru/api" + "/issues.json"))
  ...
  //API Key 288f44776e7bec4bf44fdfeb1e646490

  private int createIssue(Issue newIssue) throws IOException {
    String response = getExecutor().execute(Request.Post("https://bugify.stqa.ru/api" + "/issues.json")
